...
public class AxeDropController : MonoBehaviour {
    ...
    void OnTriggerStay(Collider other)
    {
        if (other.tag == "Player")
        {
            messageText.text = "Press 'Q' to pick up Axe.";
            if (Input.GetKeyDown(KeyCode.Q))
            {
                ...
                other.gameObject.GetComponent<PlayerController>().currentWeapon = WeaponType.Axe;
