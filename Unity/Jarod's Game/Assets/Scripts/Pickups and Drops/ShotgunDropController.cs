...
public class ShotgunDropController : MonoBehaviour {
    ...
    public float loadedAmmo=3;
    public float totalAmmo=18;
    ...
    void Update () {
        ...
        {
            Debug.Log("ShotGunDrop: Loaded:" + loadedAmmo + " / Total:" + totalAmmo);
        }
    }
    ...
    void OnTriggerStay(Collider other)
    {
        if (other.tag == "Player")
        {
            messageText.text = "Press 'Q' to pick up Shotgun.";
            if (Input.GetKeyDown(KeyCode.Q))
            {
                ...
                other.gameObject.GetComponent<PlayerController>().currentWeapon = WeaponType.Shotgun;
